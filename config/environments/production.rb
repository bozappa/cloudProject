Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'bozappa-cloud-app.herokuapp.com', :protocol => 'https'}
  ...
  # config.active_job.queue_name_prefix = "cloudProject_production"
